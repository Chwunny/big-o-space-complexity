...
// ANSWER: Still O(n), but the function below gets rid of the unnecessary variables taking up space

const getNumbersSquared2 = (numbers) => {
...
// ANSWER: Both functions depend on the size of the parameter (str)
